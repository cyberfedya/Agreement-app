...
public static class ClosingPhrases
{
    private static readonly Dictionary<string, string[]> ByLanguage = new()
    {
        ...
        [
            ...
            "Отлично! Все основные условия сделки согласованы. Теперь проверим детали перед созданием договора.",
        ],
        ["uz"] =
        [
            ...
            "Аъло! Битимнинг барча асосий шартлари келишилди. Энди шартнома тузишдан олдин тафсилотларни текширамиз.",
        ],
        ["en"] =
        [
            "Thank you. That's everything needed to prepare a draft agreement.",
            "Great, I have everything I need. Preparing the draft now.",
            "Great! The main terms of the deal are all set. Let's review the details before drafting the agreement.",
        ],
    };
