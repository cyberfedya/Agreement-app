...
class QuestionnaireProvider extends ChangeNotifier {
  ...
  /// Loads questions for [templateKey]. Answers are kept (auto-saved) when
  /// re-entering the same template's questionnaire, and cleared when the
  /// user starts a different template.
  Future<void> load(String templateKey) async {
    ...
    switch (await _repository.getQuestions(templateKey)) {
